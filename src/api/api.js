...
const API_URL = `${BASE_URL}/api/routines`;
...
export const updateRoutineProgress = async (id, date, progress) => {
  const response = await axios.put(`${API_URL}/${id}`, { progressDate: date, progressValue: progress });
  return response.data;
};
